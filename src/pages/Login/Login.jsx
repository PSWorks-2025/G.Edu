    ...
    return (
        <div className='bg-gray-100 flex flex-col items-center justify-center min-h-screen'>
            <div className="text-center mb-8">
                ...
                <p className="text-gray-600">Lorem ipsum dolor sit amet consectetur. Et lectus tempus viverra habitant nulla.</p>
            </div>
            <div style={{backgroundColor:"#F9F9F9"}} className="p-8 rounded-lg shadow-md w-full max-w-lg mx-auto text-center">
                ...
                <form onSubmit={handleSignIn}>
                    <div className="mb-4">
                        ...
                        <div className="relative">
                            ...
                            />
                            {error && <ion-icon name="alert-circle-outline" style={{ color: 'red', position: 'absolute', right: '10px', top: '55%', transform: 'translateY(-50%)',fontSize:'20px' }}></ion-icon>}
                        </div>
                    ...
                    <div className="mb-4">
                        ...
                        <div className="relative">
                            ...
                            <div onClick={()=>setShowPassword(!showPassword)}>
                                {showPassword ? (<ion-icon name="eye-outline" style={{ color: '#646464', position: 'absolute', right: '10px', top: '55%', transform: 'translateY(-50%)',fontSize:'20px' }}></ion-icon>) : (<ion-icon name="eye-off-outline" style={{ color: '#646464', position: 'absolute', right: '10px', top: '55%', transform: 'translateY(-50%)',fontSize:'20px' }}></ion-icon>)}
                            </div>
                        </div>
                    </div>
