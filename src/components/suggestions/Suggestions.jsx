...
const suggestionsData = [
  {
    ...
    description:
      "Official SAT Math practice questions with answers and explanations",
    type: "Practice Test",
  },
  {
    id: 2,
    ...
    <div>
      ...
      {displayedSuggestions.map((suggestion) => (
        <div // Changed from li to div
          key={suggestion.id}
          className="bg-white p-4 rounded-lg shadow flex items-center justify-between mb-2" // Added styling and margin
        >
          <div className="flex items-center">
            ...
            {/* <ion-icon style={{color:"gray",fontSize:20, marginRight:10}} name="document-outline"></ion-icon> */}
            <div>
